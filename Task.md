...
### 🚧 進行: ✅ **B（R9）#326** → ✅ **A（R10）#327** → **C1（R11・`t` タグ管理）** 🔧 実装済・実機目視待ち（branch `feat/tag-manage-mode`）。C2 は要設計（別途）。新規バグ **R12**（desktop 切替後 tree キーボード死）も open。
