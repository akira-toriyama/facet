...
/// production.
final class RescueGeometryTests: XCTestCase {
    ...
    func testIsCornerParkedTrueAtTitleBarClampedOrigin() {
    ...
    func testIsCornerParkedTrueAtExactRequestedAnchor() {
    ...
    func testIsCornerParkedDetectsLiveReproOn5120x2160() {
    ...
    func testIsCornerParkedFalseForNormalWindow() {
    ...
    func testIsCornerParkedFalseForWindowNearBottomButLeft() {
    ...
    func testIsCornerParkedFalseWhenTopLeftWellInsideCorner() {
    ...
    func testIsCornerParkedDetectsExternalDisplayCorner() {
    ...
    func testIsCornerParkedFalseJustOutsideClampBand() {
    ...
    func testRescueTargetOffsetsVisibleFrameOrigin() {
    ...
    func testRescueTargetRespectsCustomInset() {
        let visible = CGRect(x: 0, y: 25, width: 1920, height: 1030)
        XCTAssertEqual(
    ...
    func testRescueTargetLandsInsideVisibleFrame() {
        ...
        XCTAssertEqual(target, CGPoint(x: 1944, y: 24))
    }
}
