...
struct ApplyLabelOverridesTests {
    ...
    @Test func presentKeyRelabelsLensKeepingID() {
        let secs = [lensSec(id: "section:0:Web", label: "Web",
                            windows: [win(1), win(2)])]
    ...
    @Test func workspaceUntouchedWhileLensRelabeledInSameList() {
        let secs = [wsSec(id: "ws:0", label: "Dev", src: 0),
    ...
    @Test func storedEmptyValueBlanksLensHeader() {
